...
export const READING_LIST_VISIBILITY = ["Private", "Public"] as const;

export const MY_PROFILE_PAGE = ["home", "about", "blogs",  "followers", "following", "drafts", "notes", "settings"];
// export const MY_PROFILE_PAGE = ["home", "about", "blogs", "reading-list", "followers", "following", "drafts", "notes", "settings"];
